    ...
    <div className="bg-orange-50 min-h-screen py-10 px-4 sm:py-20 sm:px-6">
      <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center lg:items-start gap-10 lg:gap-16">
        ...
        <div className="text-left mb-10 lg:mb-0 lg:w-1/2">
          ...
          <button className="bg-red-600 text-white font-bold px-6 sm:px-8 lg:px-10 py-3 sm:py-4 text-lg hover:text-black sm:text-xl rounded-lg hover:bg-red-600 hover:bg-transparent transition duration-300">
            Explore More
          </button>
        </div>
        ...
        <div className="relative w-full sm:max-w-[450px] lg:max-w-[350px]">
          ...
          <button
            onClick={prevSlide}
            className="absolute left-4 sm:left-6 lg:left-0 top-1/2 -translate-y-1/2 bg-yellow-500 p-3 sm:p-4 rounded-lg  hover:bg-transparent transition duration-300 shadow-lg"
            style={{ zIndex: 10 }}
          >
          ...
          <button
            onClick={nextSlide}
            className="absolute right-4 sm:right-6 lg:right-0 top-1/2 -translate-y-1/2 bg-yellow-500 p-3 sm:p-4 rounded-lg hover:bg-transparent transition duration-300 shadow-lg"
            style={{ zIndex: 10 }}
          >
